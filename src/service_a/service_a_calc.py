...
class ServiceACalculation(HelicsSimulationExecutor):
    ...
    def __init__(self):
        ...
        publication_values = [
            PublicationDescription(
                True, "EConnection", "Schedule", "W", h.HelicsDataType.VECTOR
            )
        ]

        e_connection_period_in_seconds = 21600

        calculation_information_schedule = HelicsCalculationInformation(
            e_connection_period_in_seconds,
            0,
            False,
            False,
            True,
    ...
    def e_connection_dispatch(
        ...
        )  # returns the first value in param dict with "PV_Dispatch" in the key name
        ...
        ret_val["EConnectionDispatch"] = single_dispatch_value / 2
...
if __name__ == "__main__":
    ...
    helics_simulation_executor = ServiceACalculation()
